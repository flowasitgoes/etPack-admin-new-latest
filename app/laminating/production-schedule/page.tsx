...
export default function LaminatingProductionSchedule() {
  ...
  return (
    <div className="bagging-container space-y-6">
            ...
            <Table>
              <TableHeader>
                <TableRow className="transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted text-white border-b [&:hover]:bg-[rgb(228, 156, 192)]" style={{ background: 'rgb(118, 81, 99)' }}>
                  ...
                  <TableHead className="[&:has([role=checkbox])]:pr-0 h-12 px-4 text-left align-middle text-white font-semibold">貼合機台</TableHead>
                  ...
                  pendingOrders.map((order, index) => (
                    <TableRow key={index} className="border-b hover:bg-gray-50">
                      <TableCell className="p-4 align-middle bg-purple-100 font-medium">
                        <Link 
                          href={`/laminating/${order.orderNumber}`}
                      ...
                      <TableCell className="p-4 align-middle">
                        ...
                        >
                          ...
                          <SelectContent>
                            <SelectItem value="貼合機A">貼合機A</SelectItem>
                            <SelectItem value="貼合機B">貼合機B</SelectItem>
                            <SelectItem value="貼合機C">貼合機C</SelectItem>
                          </SelectContent>
                        </Select>
                      </TableCell>
                      <TableCell className="p-4 align-middle">
      ...
      <div className="bg-white rounded-lg shadow-md">
        <div className="text-white p-3 rounded-tr-lg rounded-br-lg w-[200px]" style={{ background: '#7c7d99' }}>
          <h2 className="text-base font-semibold leading-tight">貼合機台生產排程列表</h2>
        </div>
        <div className="p-4">
                  ...
                  {machineSchedules.map((schedule, index) => (
                    <TableRow key={index} className="border-b hover:bg-gray-50">
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule1 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule1 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule1}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule1}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule2 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule2 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule2}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule2}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule3 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule3 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule3}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule3}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule4 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule4 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule4}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule4}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule5 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule5 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule5}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule5}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule6 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule6 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule6}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule6}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule7 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule7 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule7}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule7}
                          </Link>
                      ...
                      <TableCell className={`p-4 align-middle min-w-[150px] ${schedule.schedule8 ? "bg-gray-100" : ""}`}>
                        {schedule.schedule8 ? (
                          <Link 
                            href={`/laminating/${schedule.schedule8}`}
                            className="text-blue-600 hover:text-blue-800 hover:underline cursor-pointer"
                          >
                            {schedule.schedule8}
                          </Link>
