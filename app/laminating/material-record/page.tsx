...
import LaminatingStandaloneSidebar from "../../components/laminating-standalone-sidebar"
        ...
        <div className="flex h-screen">
          ...
          <div className="middle-col-section flex-1 flex transition-all duration-300 ease-in-out overflow-hidden">
            <div className="flex-1 transition-opacity duration-150 ease-in-out overflow-y-auto">
              <div className="material-record-container space-y-6 p-6">
                {/* Header */}
                ...
                <div className="bg-white rounded-lg shadow-md">
                  <div className="text-white p-3 rounded-tr-lg rounded-br-lg w-[200px]" style={{ background: '#7c7d99' }}>
                    <h2 className="text-base font-semibold leading-tight">貼合領料單記錄</h2>
                  </div>
                  ...
                  <div className="p-6 space-y-6">
                    {materialRecords.map((record, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        ...
                        {/* 領料單號 */}
                        <div className="text-white p-3 rounded mb-4" style={{ background: 'rgb(218, 163, 136)' }}>
