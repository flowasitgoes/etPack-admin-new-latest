...
import SlittingProductionSchedule from "./production-schedule/page"
  ...
  const renderActiveModule = () => {
    switch (activeModule) {
      case "production-schedule":
        return <SlittingProductionSchedule />
    ...
    <div className="admin-container min-h-screen bg-gradient-to-br p-4">
      <div className="max-w-[1600px] mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="flex h-screen">
          {/* Left Sidebar */}
          <SlittingSidebar activeModule={activeModule} onModuleChange={handleModuleChange} />
