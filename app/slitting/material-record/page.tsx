...
import SlittingStandaloneSidebar from "../../components/slitting-standalone-sidebar"
              ...
              <div className="material-record-container space-y-6 p-6">
                ...
                <div className="bg-white rounded-lg shadow-md">
                  <div className="text-white p-3 rounded-tr-lg rounded-br-lg w-[200px]" style={{ background: '#7c7d99' }}>
                    <h2 className="text-base font-semibold leading-tight">分條領料單記錄</h2>
                  </div>
                  ...
                  <div className="p-6 space-y-6">
                    {materialRecords.map((record, index) => (
                      <div key={index} className="border border-gray-200 rounded-lg p-4">
                        ...
                        {/* 領料單號 */}
                        <div className="text-white p-3 rounded mb-4" style={{ background: 'rgb(135, 191, 141)' }}>
