...
import { useCuttingProductionSpecs } from "@/app/contexts/cutting-production-specs-context"

interface CuttingProductionSpecsProps {
  useStaticData?: boolean
}

export default function CuttingProductionSpecs({ useStaticData = false }: CuttingProductionSpecsProps) {
  const { productionSpecs, deleteProductionSpec, editProductionSpec } = useCuttingProductionSpecs()
