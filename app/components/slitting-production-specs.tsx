...
import { useSlittingProductionSpecs } from "@/app/contexts/slitting-production-specs-context"

interface SlittingProductionSpecsProps {
  useStaticData?: boolean
}

export default function SlittingProductionSpecs({ useStaticData = false }: SlittingProductionSpecsProps) {
  const { productionSpecs, deleteProductionSpec, editProductionSpec } = useSlittingProductionSpecs()
