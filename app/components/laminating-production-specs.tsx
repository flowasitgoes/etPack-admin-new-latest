...
import { useLaminatingProductionSpecs } from "@/app/contexts/laminating-production-specs-context"

interface LaminatingProductionSpecsProps {
  useStaticData?: boolean
}

export default function LaminatingProductionSpecs({ useStaticData = false }: LaminatingProductionSpecsProps) {
  const { productionSpecs, deleteProductionSpec, editProductionSpec } = useLaminatingProductionSpecs()
