      ...
      <div className="grid grid-cols-2 gap-6 mb-6">
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base md:text-sm flex-1 bg-gray-50">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex h-10 items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm w-20 bg-gray-50">
              <span>{formData.orderUnit1}</span>
            </div>
            <div className="flex h-10 rounded-md border border-input bg-background px-3 py-2 text-base md:text-sm w-20 bg-gray-50">
