...
export default function SlittingStandaloneSidebar() {
  ...
  const getActiveModule = () => {
    if (pathname === '/slitting/order-record') return 'order-record'
    if (pathname === '/slitting/material-record') return 'material-record'
    if (pathname === '/slitting/daily-report') return 'daily-report'
    ...
    <div className="admin-left-sidebar bg-gray-50 flex flex-col h-full">
      ...
      <nav className="space-y-2 px-4">
        ...
        <div 
          ...
          onClick={() => router.push('/slitting/recipe-database')}
        >
          配方資料庫
        </div>
      </nav>
