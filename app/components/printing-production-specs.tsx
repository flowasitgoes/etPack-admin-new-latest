...
import { usePrintingProductionSpecs } from "@/app/contexts/printing-production-specs-context"

interface PrintingProductionSpecsProps {
  useStaticData?: boolean
}

export default function PrintingProductionSpecs({ useStaticData = false }: PrintingProductionSpecsProps) {
  const { productionSpecs, deleteProductionSpec, editProductionSpec } = usePrintingProductionSpecs()
